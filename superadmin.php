...
<body>
	...
	<div class="container-fluid bg-light upBar">
		<div class="row mb-5">
			<a class="col-2 text-left p-2" href="manage.php"><button class="btn btn-danger">Manage users</button></a>
			<h1 class="col-8 text-center text-warning">Hello Overlord</h1>
			<a class="col-2 text-right p-2" href="create.php"><button class="btn btn-warning">Add Animal</button></a>
		...
		echo "
			...
			<div class='card' style='width: 18rem;'>
			  ...
			  <div class='card-body bg-light'>
			    ...
			    <p class='card-text'><small>Available: ".$value['available']."</small></p>
			    <p class='card-text'><small>Size: ".$value['size']."</small></p>
			    <p class='card-text'>".$value['description']."</p>
			    <a href='update.php?id=" .$value['id_animal']."' class='btn btn-info btn-block'>Edit</a>
			    <a href='delete.php?id=" .$value['id_animal']."' class='btn btn-danger btn-block'>Delete</a>
			  </div>
			</div>
			</div>";
	}
