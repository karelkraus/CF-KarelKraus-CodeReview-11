...
<body>
	...
	<div class="container-fluid bg-light upBar">
		<div class="row mb-5">
			<h1 class="col-8 offset-2 text-center text-warning">Delete account</h1>
		...
		<?php  
			if ($_POST) {
				...
				if ($conn -> query($sql) === TRUE) {
					echo "<h2 class='text-danger text-center mb-5'>Selected account was deleted</h2>";
			        echo "<a class='btn btn-warning btn-lg btn-block mt-2' href='../manage.php'>Back to management</a>";
				}else {
